...
INSERT INTO `sys_building_product` VALUES (1,'1123','123','1',3,NULL,'','','123',123,'12','12',NULL,NULL,'浙江省','杭州市','西湖区',NULL,'','2019-03-17 15:04:28','','2019-03-28 23:06:53','312','1231'),(2,'111','111','1',1,NULL,'','','1',1,'1','11',NULL,NULL,'浙江省','杭州市','西湖区',NULL,'','2019-03-17 16:03:00','','2019-03-30 13:22:06','1','1'),(5,'some','s','12',1,NULL,'','','测试',10,'1','1',NULL,NULL,'浙江省','杭州市',NULL,NULL,'','2019-04-23 15:34:37','',NULL,'1','1');
...
INSERT INTO `sys_notice` VALUES (1,'温馨提醒：2018-07-01 若依新版本发布啦','2','新版本内容','0','admin','2018-03-16 11:33:00','ry','2018-03-16 11:33:00','管理员'),(2,'不朽3','1','<div><div>&nbsp;void&nbsp;openMax(){};<br>void&nbsp;closeMax(){};<br>void&nbsp;openDota2(){};<br>void&nbsp;check_immortal_III(){};<br><br>int&nbsp;main()<br>{<br>&nbsp;&nbsp;&nbsp;&nbsp;int&nbsp;waitingdays=0;<br>&nbsp;&nbsp;&nbsp;&nbsp;while()<br>&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;openMax();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if(check_immortal_III()==1)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;waitingdays++;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;closeMax();<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;&nbsp;&nbsp;openDota2();<br>}&nbsp;</div></div>','0','admin','2018-07-31 15:40:13','',NULL,'');
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=470 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_product_security` VALUES (2,'2018-04-20',NULL,NULL,'2019-04-20','1','1','1','2019-04-20','1','1'),(3,'2018-04-20',NULL,NULL,'2019-04-20','测试','123','2','2019-04-20','1','1'),(4,'2018-04-20',NULL,NULL,'2019-04-20','测','测试1','3','2019-04-20','rectification_status','3');
...
INSERT INTO `sys_quality_inspect` VALUES (1,'1','1','111','2018-04-20',1,'1','2019-03-30'),(3,'123','123','123','2018-04-20',12,'1','2019-04-23'),(4,'测试','测试','测试','2018-04-20',1,'3','2019-04-23');
...
INSERT INTO `sys_role_menu` VALUES (1,1),(1,2),(1,3),(1,4),(1,5),(1,6),(1,100),(1,101),(1,102),(1,103),(1,104),(1,105),(1,106),(1,107),(1,108),(1,109),(1,110),(1,111),(1,112),(1,113),(1,114),(1,115),(1,116),(1,117),(1,118),(1,119),(1,120),(1,121),(1,122),(1,123),(1,500),(1,501),(1,1000),(1,1001),(1,1002),(1,1003),(1,1004),(1,1005),(1,1006),(1,1007),(1,1008),(1,1009),(1,1010),(1,1011),(1,1012),(1,1013),(1,1014),(1,1015),(1,1016),(1,1017),(1,1018),(1,1019),(1,1020),(1,1021),(1,1022),(1,1023),(1,1024),(1,1025),(1,1026),(1,1027),(1,1028),(1,1029),(1,1030),(1,1031),(1,1032),(1,1033),(1,1034),(1,1035),(1,1036),(1,1037),(1,1038),(1,1039),(1,1040),(1,1041),(1,1042),(1,1043),(1,1044),(1,1045),(1,1046),(1,1047),(1,1048),(1,1049),(1,1050),(1,1051),(1,1052),(1,1053),(1,1054),(1,1055),(1,1056),(1,1057),(1,1058),(1,1059),(1,1060),(1,1061),(1,1062),(1,1063),(1,1064),(2,4),(2,5),(2,6),(2,115),(2,116),(2,117),(2,118),(2,119),(2,120),(2,121),(2,122),(2,123),(2,1057),(2,1058),(2,1059),(2,1060),(2,1061),(2,1062),(2,1063),(2,1064);
...
INSERT INTO `sys_user` VALUES (1,106,'admin','admin1','00','jxj@163.com','15888888888','1','','81700418658c0bc63c4fae00512e3cb5','ff6003','0','0','127.0.0.1','2019-04-23 09:42:12','admin','2018-03-16 11:33:00','jxj','2019-04-23 17:42:11','jxj'),(8,100,'dragon','dragon','00','296569845@qq.com','18328463514','0','','410b4d3a05a6b6df28a4b50c23973ee1','140e03','0','0','127.0.0.1','2019-03-30 08:02:49','admin','2019-03-30 15:51:10','','2019-03-30 16:02:49',''),(9,NULL,'some','some','00','296569841@qq.com','18245451121','0','','21bab44e538130c556894cf4864a707f','968ed3','1','0','',NULL,'','2019-04-23 15:23:32','',NULL,''),(10,100,'some2','some2','00','296569815@qq.com','18245451111','0','','88f5ec9c5ff7682a1f3cec58943fe2e9','81d820','1','0','',NULL,'','2019-04-23 15:30:13','',NULL,'');
...
-- Dump completed on 2019-04-23 17:53:10

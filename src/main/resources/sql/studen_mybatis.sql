...
CREATE TABLE `sys_building_product` (
  ...
  `product_area` float DEFAULT NULL COMMENT '项目面积（㎡）',
  `product_length` float DEFAULT NULL COMMENT '项目长度（m）',
...
-- ----------------------------
-- Records of sys_building_product
-- ----------------------------
...
INSERT INTO `sys_logininfor` VALUES ('136', 'admin', '127.0.0.1', 'XX 内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2018-08-04 10:44:08');
INSERT INTO `sys_logininfor` VALUES ('137', 'admin', '127.0.0.1', 'XX 内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2018-08-04 14:37:42');
INSERT INTO `sys_logininfor` VALUES ('138', 'admin', '127.0.0.1', null, 'Chrome', 'Windows 10', '0', '登录成功', '2019-02-23 15:02:35');
INSERT INTO `sys_logininfor` VALUES ('139', 'admin', '127.0.0.1', null, 'Chrome', 'Windows 10', '0', '登录成功', '2019-02-25 14:32:15');
INSERT INTO `sys_logininfor` VALUES ('140', 'admin', '127.0.0.1', 'XX 内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-02-25 14:55:24');
INSERT INTO `sys_logininfor` VALUES ('141', 'admin', '127.0.0.1', null, 'Chrome', 'Windows 10', '0', '登录成功', '2019-02-25 16:35:42');
INSERT INTO `sys_logininfor` VALUES ('142', 'admin', '127.0.0.1', 'XX 内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-02-25 16:39:07');
INSERT INTO `sys_logininfor` VALUES ('143', 'admin', '127.0.0.1', null, 'Chrome', 'Windows 10', '0', '登录成功', '2019-02-25 16:46:51');
INSERT INTO `sys_logininfor` VALUES ('144', 'admin', '127.0.0.1', 'XX 内网IP', 'Chrome', 'Windows 10', '1', '验证码错误', '2019-02-25 16:50:43');
INSERT INTO `sys_logininfor` VALUES ('145', 'admin', '127.0.0.1', 'XX 内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-02-25 16:50:47');
INSERT INTO `sys_logininfor` VALUES ('146', 'admin', '127.0.0.1', 'XX 内网IP', 'Chrome', 'Windows 10', '1', '验证码错误', '2019-02-25 16:54:17');
INSERT INTO `sys_logininfor` VALUES ('147', 'admin', '127.0.0.1', 'XX 内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-02-25 16:54:20');
INSERT INTO `sys_logininfor` VALUES ('148', 'admin', '127.0.0.1', null, 'Chrome', 'Windows 10', '0', '登录成功', '2019-02-25 16:56:29');
INSERT INTO `sys_logininfor` VALUES ('149', 'admin', '127.0.0.1', null, 'Chrome', 'Windows 10', '0', '登录成功', '2019-02-25 17:04:04');
INSERT INTO `sys_logininfor` VALUES ('150', 'admin', '127.0.0.1', null, 'Chrome', 'Windows 10', '0', '登录成功', '2019-02-26 15:12:02');
INSERT INTO `sys_logininfor` VALUES ('151', 'admin', '127.0.0.1', 'XX 内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-02-26 15:23:35');
INSERT INTO `sys_logininfor` VALUES ('152', 'admin', '127.0.0.1', null, 'Chrome', 'Windows 10', '0', '登录成功', '2019-02-26 15:36:01');
INSERT INTO `sys_logininfor` VALUES ('153', 'admin', '127.0.0.1', null, 'Chrome', 'Windows 10', '1', '验证码错误', '2019-03-03 19:35:15');
INSERT INTO `sys_logininfor` VALUES ('154', 'admin', '127.0.0.1', null, 'Chrome', 'Windows 10', '0', '登录成功', '2019-03-03 19:35:23');
INSERT INTO `sys_logininfor` VALUES ('155', 'admin', '127.0.0.1', null, 'Chrome', 'Windows 10', '0', '登录成功', '2019-03-03 20:10:29');
INSERT INTO `sys_logininfor` VALUES ('156', 'admin', '127.0.0.1', null, 'Chrome', 'Windows 10', '0', '登录成功', '2019-03-03 21:06:00');
INSERT INTO `sys_logininfor` VALUES ('157', 'admin', '127.0.0.1', 'XX 内网IP', 'Chrome', 'Windows 10', '1', '验证码错误', '2019-03-03 21:10:53');
INSERT INTO `sys_logininfor` VALUES ('158', 'admin', '127.0.0.1', 'XX 内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-03-03 21:10:56');
INSERT INTO `sys_logininfor` VALUES ('159', 'admin', '127.0.0.1', null, 'Chrome', 'Windows 10', '0', '登录成功', '2019-03-03 21:13:13');
INSERT INTO `sys_logininfor` VALUES ('160', 'admin', '127.0.0.1', null, 'Chrome', 'Windows 10', '0', '登录成功', '2019-03-03 21:21:26');
...
CREATE TABLE `sys_menu` (
  ...
  `remark` varchar(500) DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1059 DEFAULT CHARSET=utf8 COMMENT='菜单权限表';
...
INSERT INTO `sys_menu` VALUES ('4', '建筑管理', '0', '4', '#', 'M', '0', '', 'fa fa-edit', 'admin', '2018-07-27 11:34:59', 'lxl', '2018-07-27 11:35:07', '功能管理');
...
INSERT INTO `sys_menu` VALUES ('115', '项目管理', '4', '1', '/building/product', 'C', '0', 'building:product:view', '#', 'admin', '2019-02-25 14:49:01', 'ry', '2019-02-25 14:49:11', '建筑管理菜单');
...
INSERT INTO `sys_menu` VALUES ('1057', '项目保存', '115', '1', '#', 'F', '0', 'building:product:save', '#', 'admin', '2019-03-03 19:54:47', 'ry', null, '');
INSERT INTO `sys_menu` VALUES ('1058', '项目添加', '115', '2', '#', 'f', '0', 'building:product:add', '#', 'admin', '2019-03-03 21:32:36', 'ry', null, '');
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=135 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';
...
INSERT INTO `sys_oper_log` VALUES ('94', '用户管理', '6', 'com.student.controller.UserController.export()', '1', 'admin', '研发一部', '/system/user/export', '127.0.0.1', 'XX 内网IP', '{\"deptId\":[\"\"],\"parentId\":[\"\"],\"loginName\":[\"\"],\"phonenumber\":[\"\"],\"status\":[\"\"]}', '0', null, '2018-08-04 14:40:48');
INSERT INTO `sys_oper_log` VALUES ('95', '角色管理', '6', 'com.student.controller.RoleController.export()', '1', 'admin', '研发一部', '/system/role/export', '127.0.0.1', 'XX 内网IP', '{\"roleName\":[\"\"],\"roleKey\":[\"\"],\"status\":[\"\"]}', '0', null, '2018-08-04 14:41:01');
INSERT INTO `sys_oper_log` VALUES ('96', '菜单管理', '1', 'com.student.controller.MenuController.add()', '1', 'admin', '研发一部', '/system/menu/add/0', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-25 16:41:14');
INSERT INTO `sys_oper_log` VALUES ('97', '菜单管理', '1', 'com.student.controller.MenuController.add()', '1', 'admin', '研发一部', '/system/menu/add/0', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-25 16:41:55');
INSERT INTO `sys_oper_log` VALUES ('98', '用户管理', '1', 'com.student.controller.UserController.add()', '1', 'admin', '研发一部', '/system/user/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-25 16:48:14');
INSERT INTO `sys_oper_log` VALUES ('99', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-25 16:50:53');
INSERT INTO `sys_oper_log` VALUES ('100', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-25 16:51:36');
INSERT INTO `sys_oper_log` VALUES ('101', '用户管理', '1', 'com.student.controller.UserController.add()', '1', 'admin', '研发一部', '/system/user/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-25 16:56:37');
INSERT INTO `sys_oper_log` VALUES ('102', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', null, '{}', '0', null, '2019-02-25 17:04:12');
INSERT INTO `sys_oper_log` VALUES ('103', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', null, '{}', '0', null, '2019-02-25 17:04:59');
INSERT INTO `sys_oper_log` VALUES ('104', '角色管理', '1', 'com.student.controller.RoleController.add()', '1', 'admin', '研发一部', '/system/role/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-25 17:07:57');
INSERT INTO `sys_oper_log` VALUES ('105', '参数管理', '1', 'com.student.controller.ConfigController.add()', '1', 'admin', '研发一部', '/system/config/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-25 17:08:07');
INSERT INTO `sys_oper_log` VALUES ('106', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-25 17:08:50');
INSERT INTO `sys_oper_log` VALUES ('107', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', null, '{}', '0', null, '2019-02-25 17:12:42');
INSERT INTO `sys_oper_log` VALUES ('108', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', null, '{}', '0', null, '2019-02-25 17:15:00');
INSERT INTO `sys_oper_log` VALUES ('109', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-25 17:15:30');
INSERT INTO `sys_oper_log` VALUES ('110', '定时任务', '2', 'com.student.controller.monitor.JobController.edit()', '1', 'admin', '研发一部', '/monitor/job/edit/1', '127.0.0.1', null, '{}', '0', null, '2019-02-25 17:19:28');
INSERT INTO `sys_oper_log` VALUES ('111', '字典类型', '2', 'com.student.controller.DictTypeController.edit()', '1', 'admin', '研发一部', '/system/dict/edit/1', '127.0.0.1', null, '{}', '0', null, '2019-02-25 17:19:42');
INSERT INTO `sys_oper_log` VALUES ('112', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', null, '{}', '0', null, '2019-02-25 17:32:10');
INSERT INTO `sys_oper_log` VALUES ('113', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', null, '{}', '0', null, '2019-02-26 15:12:41');
INSERT INTO `sys_oper_log` VALUES ('114', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', null, '{}', '0', null, '2019-02-26 15:20:25');
INSERT INTO `sys_oper_log` VALUES ('115', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-26 15:22:01');
INSERT INTO `sys_oper_log` VALUES ('116', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-26 15:22:36');
INSERT INTO `sys_oper_log` VALUES ('117', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-26 15:23:41');
INSERT INTO `sys_oper_log` VALUES ('118', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-26 15:24:45');
INSERT INTO `sys_oper_log` VALUES ('119', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-26 15:25:22');
INSERT INTO `sys_oper_log` VALUES ('120', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-26 15:34:18');
INSERT INTO `sys_oper_log` VALUES ('121', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-26 15:36:07');
INSERT INTO `sys_oper_log` VALUES ('122', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-26 15:37:03');
INSERT INTO `sys_oper_log` VALUES ('123', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', null, '{}', '0', null, '2019-02-26 15:38:11');
INSERT INTO `sys_oper_log` VALUES ('124', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-26 15:39:24');
INSERT INTO `sys_oper_log` VALUES ('125', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-26 15:47:28');
INSERT INTO `sys_oper_log` VALUES ('126', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-02-26 15:50:49');
INSERT INTO `sys_oper_log` VALUES ('127', '用户管理', '1', 'com.student.controller.UserController.add()', '1', 'admin', '研发一部', '/system/user/add', '127.0.0.1', null, '{}', '0', null, '2019-02-26 15:55:58');
INSERT INTO `sys_oper_log` VALUES ('128', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-03-03 19:35:28');
INSERT INTO `sys_oper_log` VALUES ('129', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', null, '{}', '0', null, '2019-03-03 19:40:54');
INSERT INTO `sys_oper_log` VALUES ('130', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', null, '{}', '0', null, '2019-03-03 19:42:03');
INSERT INTO `sys_oper_log` VALUES ('131', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-03-03 20:10:35');
INSERT INTO `sys_oper_log` VALUES ('132', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-03-03 21:13:19');
INSERT INTO `sys_oper_log` VALUES ('133', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', null, '{}', '0', null, '2019-03-03 21:21:33');
INSERT INTO `sys_oper_log` VALUES ('134', '项目添加', '1', 'com.student.controller.building.ProductController.add()', '1', 'admin', '研发一部', '/building/product/add', '127.0.0.1', 'XX 内网IP', '{}', '0', null, '2019-03-03 21:25:07');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '106', 'admin', '蒋小姐', '00', 'jxj@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2019-03-03 21:21:26', 'admin', '2018-03-16 11:33:00', 'jxj', '2019-03-03 21:21:26', 'jxj');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('91680006-dc58-484b-b0be-8b58738bfa79', 'admin', '研发一部', '127.0.0.1', 'XX 内网IP', 'Chrome', 'Windows 10', 'on_line', '2019-03-03 21:19:06', '2019-03-03 21:33:51', '1800000');

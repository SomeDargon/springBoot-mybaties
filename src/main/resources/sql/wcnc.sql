...
INSERT INTO `sys_building_product` VALUES (1,'1123','123','1',3,NULL,'','','123',123,'12','12',NULL,NULL,'浙江省','杭州市','西湖区',NULL,'','2019-03-17 15:04:28','','2019-03-28 23:06:53','312','1231'),(2,'111','111','1',1,NULL,'','','1',1,'1','1',NULL,NULL,'浙江省','杭州市',NULL,NULL,'','2019-03-17 16:03:00','',NULL,'1','1');
...
INSERT INTO `sys_dept` VALUES (100,0,'蒋小姐集团',0,'蒋小姐','15888888888','ry@qq.com','0','admin','2018-03-16 11:33:00','jxj','2018-03-16 11:33:00'),(101,100,'研发部门',1,'蒋小姐','15888888888','ry@qq.com','0','admin','2018-03-16 11:33:00','jxj','2018-03-16 11:33:00'),(102,100,'市场部门',2,'蒋小姐','15888888888','ry@qq.com','0','admin','2018-03-16 11:33:00','jxj','2018-03-16 11:33:00'),(103,100,'测试部门',3,'蒋小姐','15888888888','ry@qq.com','0','admin','2018-03-16 11:33:00','jxj','2018-03-16 11:33:00'),(104,100,'财务部门',4,'蒋小姐','15888888888','ry@qq.com','0','admin','2018-03-16 11:33:00','jxj','2018-03-16 11:33:00'),(105,100,'运维部门',5,'蒋小姐','15888888888','ry@qq.com','0','admin','2018-03-16 11:33:00','jxj','2018-03-16 11:33:00'),(106,101,'研发一部',1,'蒋小姐','15888888888','ry@qq.com','0','admin','2018-03-16 11:33:00','jxj','2018-03-16 11:33:00'),(107,101,'研发二部',2,'蒋小姐','15888888888','ry@qq.com','0','admin','2018-03-16 11:33:00','jxj','2018-03-16 11:33:00'),(108,102,'市场一部',1,'蒋小姐','15888888888','ry@qq.com','0','admin','2018-03-16 11:33:00','jxj','2018-03-16 11:33:00'),(109,102,'市场二部',2,'蒋小姐','15888888888','ry@qq.com','1','admin','2018-03-16 11:33:00','jxj','2018-03-16 11:33:00');
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=280 DEFAULT CHARSET=utf8 COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=296 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_product_security` (
  ...
  `securty_type` varchar(255) DEFAULT NULL COMMENT '检查性质',
...
INSERT INTO `sys_project_work_log` VALUES (1,'2','3','4','5','6','7','8',NULL),(2,'12','12','13',NULL,'123',NULL,'','2019-03-17 19:47:20');
...
INSERT INTO `sys_role` VALUES (1,'管理员','admin',1,'0','admin','2018-03-16 11:33:00','ry','2018-03-16 11:33:00','管理员'),(2,'普通角色','common',2,'0','admin','2018-03-16 11:33:00','ry','2018-03-16 11:33:00','普通角色');
...
CREATE TABLE `sys_stock_manager` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='库存管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_storage` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='入库管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_storage` VALUES (1,NULL,'1','1',1,NULL,'2019-03-28 23:52:05','1','','1.0');
...
INSERT INTO `sys_task_manager` VALUES (3,'3','3','12',3,12,'','2019-03-28 22:50:36',3,'2019-03-28 22:57:29'),(4,'1123','123','123',123,123,'2018-04-20','2019-03-28 22:53:53',123,NULL);
...
INSERT INTO `sys_user` VALUES (1,106,'admin','admin','00','jxj@163.com','15888888888','1','','29c67a30398638269fe600f73a054934','111111','0','0','127.0.0.1','2019-03-28 15:50:42','admin','2018-03-16 11:33:00','jxj','2019-03-28 23:50:42','jxj'),(4,106,'jiangxiaojie','dargon','00','296569845@qq.com','18324191811','0','','a0f4e09c52e8b79c1068f91ac62c2b04','95e77a','0','2','',NULL,'admin','2018-07-30 15:42:29','','2018-07-31 11:29:55',''),(5,106,'jiangxiaojie','jiangxiaojie','00','296569841@qq.com','13478539991','0','','f3712626d1ef5a5131b11412e280d72f','495a6d','0','0','',NULL,'admin','2018-07-30 15:50:50','admin','2018-07-31 11:36:32',''),(7,106,'dragon','dragon','00','296569145@qq.com','18328463514','0','','2163a5c8ca3a2517cc9d21953f7b6d31','1af5af','0','0','127.0.0.1','2019-03-25 14:09:43','admin','2019-03-25 22:08:39','','2019-03-25 22:09:42','');
...
INSERT INTO `sys_user_online` VALUES ('b1586b25-fde8-41f4-91cf-621e72c41c15','admin','研发一部','127.0.0.1',NULL,'Chrome','Ubuntu','on_line','2019-03-28 15:50:35','2019-03-28 15:51:15',1800000);
...
INSERT INTO `sys_user_post` VALUES ('1','1'),('2','2'),('4','1'),('5','1'),('5','2'),('6','4'),('7','4');
...
INSERT INTO `sys_user_role` VALUES (1,1),(2,2),(4,1),(5,1),(6,2),(7,2);
...
-- Dump completed on 2019-03-28 23:53:15

...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=333 DEFAULT CHARSET=utf8 COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=405 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user` VALUES (1,106,'admin','admin','00','jxj@163.com','15888888888','1','','81700418658c0bc63c4fae00512e3cb5','ff6003','0','0','127.0.0.1','2019-03-30 06:41:40','admin','2018-03-16 11:33:00','jxj','2019-03-30 14:41:39','jxj');
...
INSERT INTO `sys_user_online` VALUES ('23203ed7-7c2b-4646-b22c-7d4e8354f461','admin','研发一部','127.0.0.1','XX 内网IP','Chrome','Ubuntu','on_line','2019-03-30 06:41:35','2019-03-30 06:43:25',1800000);
...
-- Dump completed on 2019-03-30 14:44:08
